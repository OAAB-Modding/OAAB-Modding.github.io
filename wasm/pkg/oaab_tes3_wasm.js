/* @ts-self-types="./oaab_tes3_wasm.d.ts" */
 ...
 * @returns {string}
 */
export function parse_nif(bytes) {
    let deferred3_0;
    let deferred3_1;
    try {
        ...
        wasm.parse_nif(retptr, ptr0, len0);
 ...
 * @returns {string}
 */
export function parse_plugin(bytes) {
    let deferred3_0;
    let deferred3_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        wasm.parse_plugin(retptr, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('oaab_tes3_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
